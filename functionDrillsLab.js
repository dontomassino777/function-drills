...
function add(param1, param2) {
  let param1num = parseInt(param1)
  let param2num = parseInt(param2)
  return (param1num + param2num)
}
let sum = add(5, '25')
// console.log(sum)
...
//CODE HERE
function darkSide(str) {
  console.log(str.toUpperCase())
}
// darkSide(sampleString)
...
//       console.log(`${array[n]} + ${array[i]}`)
//     }
//   }
// console.log(funAscend(sampleArray))

// let arrayIsAscending = funAscend(sampleArray)
////////////////// PROBLEM 16 ////////////////////
